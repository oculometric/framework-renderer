...
int FSphereCollider::checkCollisionSphere(FSphereCollider* other)
{
	...
	if (colliding)
	{
		...
		float m_inv_sum = getOwner()->getInvMass() + other->getOwner()->getInvMass();
...
int FSphereCollider::checkCollisionBox(FAABBCollider* other)
{
